...
class ResBlock_DAQ(nn.Module):
    def __init__(self, conv, n_feats, kernel_size,a_bit=32, w_bit=32, qq_bit=32,finetune=False, bias=True, bn=False, act=nn.ReLU(True), res_scale=1):
