...
parser.add_argument('--seed', type=int, default=3192, help='random seed (default: 1)')
parser.add_argument("--batchSize", type=int, default=8, help="training batch size")
parser.add_argument("--nEpochs", type=int, default=200, help="maximum number of epochs to train")
parser.add_argument("--show", action="store_true", default=False, help="show Tensorboard")
...
parser.add_argument("--datasetName", default="Harvard", type=str, help="data name")
...
# Test image
parser.add_argument('--model_name', default='checkpoint/model_4_epoch_200.pth', type=str,
